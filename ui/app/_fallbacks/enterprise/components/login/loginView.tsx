...
import { buildSSOLoginURL } from "@/lib/utils/ssoLogin";
...
export default function LoginView() {
	...
	const { data: authState, isLoading: isAuthStateLoading } = useIsAuthEnabledQuery();
	...
	const handleSSOLogin = () => {
		...
		window.location.href = buildSSOLoginURL(getApiBaseUrl(), search);
	};

	const { logoSrc, logoAlt } = useBranding(mounted && resolvedTheme === "dark");
	const isOIDCLogin = authState?.auth_type === "oidc";
					...
					{isOIDCLogin ? (
						<div className="space-y-5">
							...
							<Button
								...
								isLoading={isLoading || isAuthStateLoading}
								disabled={isLoading || isAuthStateLoading}
